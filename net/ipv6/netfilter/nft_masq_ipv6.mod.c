...
__attribute__((section("__versions"))) = {
	...
	{ 0x67b1dd69, "nf_nat_masquerade_ipv6_register_notifier" },
	{ 0xfb51ac3f, "nft_register_expr" },
	{ 0xdb7305a1, "__stack_chk_fail" },
	{ 0xbe60b8fd, "nf_nat_masquerade_ipv6" },
	{ 0x5f754e5a, "memset" },
...
"depends=nft_masq,nf_nat_ipv6,nf_tables,nf_conntrack";


MODULE_INFO(srcversion, "AA7F043B8C368586CF2209D");
