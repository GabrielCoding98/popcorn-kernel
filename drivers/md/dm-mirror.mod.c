...
__attribute__((section("__versions"))) = {
	...
	{ 0xcf6e2246, "dm_rh_bio_to_region" },
	...
	{ 0x37a0cba, "kfree" },
	{ 0xe12108f1, "dm_rh_mark_nosync" },
	{ 0x203240d4, "dm_dirty_log_destroy" },
	...
	{ 0x150c372c, "dm_rh_delay" },
	{ 0xca54fee, "_test_and_set_bit" },
	{ 0x49ebacbd, "_clear_bit" },
	{ 0x73a7a766, "param_ops_uint" },
	{ 0x771ab2c0, "dm_dirty_log_create" },
